...
export default function ICPContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send ICP creation request with retry mechanism
      await safeEmit('send_message', {
        message: `Create an Ideal Customer Profile (ICP) for this startup/business: ${userInput}.`,
